        ...
        <div className="bg-white border-2 border-[#003AAD] rounded-3xl p-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-3 text-base font-semibold text-[#003AAD] bg-[#FDB913] border-2 border-[#FDB913] rounded-lg hover:bg-[#f5b400] transition-colors min-w-[250px]"
            >
              Join Early Access Now
            </button>
            <a
              href="https://vendor.exaltride.com"
              className="inline-flex items-center justify-center px-8 py-3 text-base font-semibold text-[#003AAD] border-2 border-[#003AAD] bg-white rounded-lg hover:bg-[#003AAD] hover:text-white transition-colors min-w-[250px]"
            >
              Become a Vendor
            </a>
          </div>
