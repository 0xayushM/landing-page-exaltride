            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex gap-2 flex-col">
                  <button className="flex-1 bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold py-2.5 px-3 rounded-lg transition-colors text-xs sm:text-sm flex items-center justify-center gap-1.5">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
